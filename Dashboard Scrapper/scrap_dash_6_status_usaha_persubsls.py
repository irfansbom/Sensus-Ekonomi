...
FOLDER_OUTPUT = "scrap_status_usaha"
MAX_RETRY_PER_SLS = (5)
    ...
    for percobaan in range(1, MAX_RETRY_PER_SLS + 1):
        try:
            response = context.request.get(
                ...
                params={
                    "level": "sub_sls",
                    "indikator": "108,109,110,10264,10265,10247,10266,10268,14,882,10691,10693,10694,10695,10696,10246",
                    "kabupaten": kab,
                },
...
def main():
    ...
    file_excel = os.path.join(FOLDER_OUTPUT, f"status_usaha_sls_sumsel_{timestamp}.xlsx")
