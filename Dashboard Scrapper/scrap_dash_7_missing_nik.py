...
#    https://dashboard-se2026.apps.bps.go.id/api/mikro/missing-value-case-kab?kode_kabupaten=1601&indikator=10224
    url = (
        "https://dashboard-se2026.apps.bps.go.id/api/mikro/missing-value-case-kab"
...
# nama folder
folder = "scrap_missing_nik"
# buat folder jika belum ada
os.makedirs(folder, exist_ok=True)
# timestamp
timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
# nama file
file_excel = os.path.join(folder, f"missing_nik_{timestamp}.xlsx")
